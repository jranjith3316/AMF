 ...
 * @generated
 */
public abstract class ProfileDetailFinderBaseImpl
	extends BasePersistenceImpl<ProfileDetail> {

	public ProfileDetailFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return profileDetailPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProfileDetailFinderBaseImpl.class);
