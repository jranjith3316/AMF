...
/**
 * Provides the local service interface for ProfileDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProfileDetailLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProfileDetailLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.amf.profile.detail.service.impl.ProfileDetailLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the profile detail local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProfileDetailLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProfileDetail> getProfileDetail(Hits hits)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Object[]> getProfileDetailSearchResult(
